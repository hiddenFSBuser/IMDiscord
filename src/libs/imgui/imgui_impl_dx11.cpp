...
#ifdef _MSC_VER
// IMDiscord: the compiler is loaded by hand instead (see core/gfxload.cpp), so
// nothing here reaches the import table and a machine without it says so
...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create the vertex shader
    {
        ...
        if (!gfx::compile() || FAILED(gfx::compile()(vertexShader, strlen(vertexShader), nullptr, nullptr, nullptr, "main", "vs_4_0", 0, 0, &vertexShaderBlob, nullptr)))
    ...
    // Create the pixel shader
    {
        ...
        if (!gfx::compile() || FAILED(gfx::compile()(pixelShader, strlen(pixelShader), nullptr, nullptr, nullptr, "main", "ps_4_0", 0, 0, &pixelShaderBlob, nullptr)))
            return false; // NB: Pass ID3DBlob* pErrorBlob to D3DCompile() to get error showing in (const char*)pErrorBlob->GetBufferPointer(). Make sure to Release() the blob!
